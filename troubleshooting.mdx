...
description: "Common issues and solutions for Prvue"
---
...
3. Check orchestrator logs:
   ...
   ```bash
   ssh root@SERVER_IP
   journalctl -u preview-orchestrator -f
   ```
...
1. Check cleanup service is running:
   ...
   ```bash
   ssh root@SERVER_IP
   journalctl -u preview-orchestrator | grep cleanup
   ```
...
# Or: journalctl -u preview-orchestrator -n 50
```
